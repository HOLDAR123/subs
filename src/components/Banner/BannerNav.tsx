...
import {ContextTimeTheme} from "@/providers/useTheme";
import classNames from "classnames";
import Link from "next/link";
import HeaderTop from "@/components/HeaderTop/HeaderTop";

export default function BannerNav() {
    const {theme} = useContext(ContextTimeTheme)
    ...
    return (
        <>
            <header ref={headerRef} className={classNames({
                ...
                <div className="headers__inner">
                    <div className="container">
                        <div className="headers__wrapper">
                            <div>
                                <Link href="/"><img src={"/assets/icon.png"} alt="logo"/></Link>
                            </div>
                            <div>
            ...
            <div className={classNames({
                'banner__nav': true,
                'banner__nav--dark': theme === 'morning' || theme === 'noon',
                ...
                <div className={"banner__navList"}>
                    <a href={"https://docs.subsquid.io/"} target="_blank" className={"din"}>
                    ...
                    <a href={"/subsquid-cloud"} className={"din"}>
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <a href={"https://blog.subsquid.io/"} target={"_blank"} className={"din"}>
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href={"https://twitter.com/subsquid"} target={"_blank"} className={"din"}>
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <a href={"https://discord.com/invite/subsquid"} target={"_blank"} className={"din"}>
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div className={"banner__navButtons"}>
                    <a href={"https://subsquid.deform.cc/quests/"} target={"_blank"} className={"banner__navTrophy din"}>
                        <img src="/trophy.svg" alt="trophy"/>
                        Join Quests
                    </a>
                    <a href={"https://app.subsquid.io/"} target={"_blank"} className={"banner__navRocket din"}>
